class GravityHelper {
    ...
    static gravityFactor = 9.81;

    static checkForGravityCollision(object1, object2) {
    ...
    static applyGravityForces(object, undoPrevious) {
        ...
        if (moveDown) {
            object.position.y += GravityHelper.gravityFactor * multiplier * object.mass;
        }
        else {
            object.antiGravityForce -= GravityHelper.gravityFactor * multiplier * object.mass;
            object.position.y -= GravityHelper.gravityFactor * multiplier * object.mass;
        }
    }

    static applyGameObjectToHitPlatform(object) {
